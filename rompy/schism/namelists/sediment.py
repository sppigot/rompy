...
class SED_CORE(NamelistBaseModel):
    Sd50: list = Field(['0.12d0', '0.18d0', '0.39d0', '0.60d0', '1.2d0'], description="")
    Erate: list = Field(['1.6d-3', '1.6d-3', '1.6d-3', '1.6d-3', '1.6d-3'], description="ierosion=0")

class SED_OPT(NamelistBaseModel):
    iSedtype: list = Field([1, 1, 1, 1, 1], description="5 classes")
    Srho: list = Field(['2650.0d0', '2650.0d0', '2650.0d0', '2650.0d0', '2650.0d0'], description="")
    comp_ws: int = Field(0, description="")
    comp_tauce: int = Field(0, description="")
    Wsed: list = Field(['1.06d0', '3.92d0', '5.43d0', '10.19d0', '28.65d0'], description="")
    tau_ce: list = Field(['0.15d0', '0.17d0', '0.23d0', '0.3d0', '0.6d0'], description="")
