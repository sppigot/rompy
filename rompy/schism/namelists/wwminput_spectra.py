...
class HOTFILE(NamelistBaseModel):
    LHOTF: str = Field('T')
    BEGTC: str = Field("'19980901.000000'")
    DELTC: int = Field(3600)
    UNITC: str = Field("'SEC'")
    ENDTC: str = Field("'19980901.060000'")
...
class BOUC(NamelistBaseModel):
    ...
    FILEWAVE: str = Field("'wwmbnd.gr3'")
    LBSP1D: str = Field('F')
    LBSP2D: str = Field('F')
    BEGTC: str = Field("'19980901.000000'")
    DELTC: int = Field(1)
    UNITC: str = Field("'HR'")
    ENDTC: str = Field("'19981002.000000'")
    FILEBOUND: str = Field("'wwmbnd.gr3'")
    IBOUNDFORMAT: int = Field(1)
    WBHS: float = Field(4.0)
    WBSS: float = Field(2.0)
    WBTP: float = Field(8.0)
    WBDM: float = Field(90.0)
    WBDSMS: float = Field(1.0)
    WBDS: float = Field(20.0)
    WBGAUSS: float = Field(0.1)
    WBPKEN: float = Field(3.3)
    NCDF_HS_NAME: str = Field("'hs'")
    NCDF_DIR_NAME: str = Field("'dir'")
    NCDF_SPR_NAME: str = Field("'spr'")
    NCDF_FP_NAME: str = Field("'fp'")
    NCDF_F02_NAME: str = Field("'t02'")
...
class SIN4(NamelistBaseModel):
    ZWND: list = Field([10.0, ''])
    ALPHA0: list = Field(['9.499999694526196E-003', ''])
    Z0MAX: list = Field(['0.000000000000000E+000', ''])
    BETAMAX: list = Field([1.54, ''])
    SINTHP: list = Field([2.0, ''])
    ZALP: list = Field(['6.000000052154064E-003', ''])
    TAUWSHELTER: list = Field([0.300000011920929, ''])
    SWELLFPAR: list = Field([1.0, ''])
    SWELLF: list = Field([0.660000026226044, ''])
    SWELLF2: list = Field(['-1.799999922513962E-002', ''])
    SWELLF3: list = Field(['2.199999988079071E-002', ''])
    SWELLF4: list = Field([150000.0, ''])
    SWELLF5: list = Field([1.20000004768372, ''])
    SWELLF6: list = Field(['0.000000000000000E+000', ''])
    SWELLF7: list = Field([360000.0, ''])
    Z0RAT: list = Field(['3.999999910593033E-002', ''])
    SINBR: str = Field('0.000000000000000E+000')

class SDS4(NamelistBaseModel):
    SDSC1: list = Field(['0.000000000000000E+000', ''])
    FXPM3: list = Field([4.0, ''])
    FXFM3: list = Field([2.5, ''])
    FXFMAGE: list = Field(['0.000000000000000E+000', ''])
    SDSC2: list = Field(['-2.200000017182902E-005', ''])
    SDSCUM: list = Field([-0.403439998626709, ''])
    SDSSTRAIN: list = Field(['0.000000000000000E+000', ''])
    SDSC4: list = Field([1.0, ''])
    SDSC5: list = Field(['0.000000000000000E+000', ''])
    SDSC6: list = Field([0.300000011920929, ''])
    SDSBR: list = Field(['8.999999845400453E-004', ''])
    SDSBR2: list = Field([0.800000011920929, ''])
    SDSP: list = Field([2.0, ''])
    SDSISO: list = Field([2.0, ''])
    SDSBCK: list = Field(['0.000000000000000E+000', ''])
    SDSABK: list = Field([1.5, ''])
    SDSPBK: list = Field([4.0, ''])
    SDSBINT: list = Field([0.300000011920929, ''])
    SDSHCK: list = Field([1.5, ''])
    SDSDTH: list = Field([80.0, ''])
    SDSCOS: list = Field([2.0, ''])
    SDSBRF1: list = Field([0.5, ''])
    SDSBRFDF: list = Field(['0.000000000000000E+000', ''])
    SDSBM0: list = Field([1.0, ''])
    SDSBM1: list = Field(['0.000000000000000E+000', ''])
    SDSBM2: list = Field(['0.000000000000000E+000', ''])
    SDSBM3: list = Field(['0.000000000000000E+000', ''])
    SDSBM4: list = Field(['0.000000000000000E+000', ''])
    SDSHFGEN: list = Field(['0.000000000000000E+000', ''])
    SDSLFGEN: list = Field(['0.000000000000000E+000', ''])
    WHITECAPWIDTH: list = Field([0.300000011920929, ''])
    FXINCUT: list = Field(['0.000000000000000E+000', ''])
    FXDSCUT: str = Field('0.000000000000000E+000')

class NUMS(NamelistBaseModel):
    ICOMP: int = Field(3)
    AMETHOD: int = Field(7)
    ASPAR_LOCAL_LEVEL: list = Field([0, ''])
    SMETHOD: int = Field(1)
    DMETHOD: int = Field(2)
    ...
    LLIMT: str = Field('T')
    LSIGBOUND: str = Field('F')
    LTHBOUND: str = Field('F')
    ...
    LCHKCONV: str = Field('T')
    NB_BLOCK: list = Field([3, ''])
    ...
    LNONL: list = Field(['F', ''])
    L_SOLVER_NORM: list = Field(['F', ''])

class HISTORY(NamelistBaseModel):
    BEGTC: str = Field("'19980901.000000'")
    DELTC: int = Field(1)
    UNITC: str = Field("'SEC'")
    ENDTC: str = Field("'19980910.000000'")
...
class STATION(NamelistBaseModel):
    ...
    DELTC: list = Field([1, ''])
    UNITC: str = Field("'SEC'")
    ENDTC: str = Field("'20081101.000000'")
    OUTSTYLE: str = Field("'STE'")
    FILEOUT: str = Field("'station.dat'")
    LOUTITER: str = Field('F')
    LLOUTS: str = Field('F')
    ILOUTS: int = Field(1)
    NLOUTS: list = Field(["'P-1'", ''])
    IOUTS: int = Field(1)
    NOUTS: list = Field(["'P-1'", ''])
    XOUTS: list = Field([1950.0, ''])
    YOUTS: list = Field([304.0, ''])
    CUTOFF: str = Field('8*0.44')
    LSP1D: str = Field('F')
    LSP2D: str = Field('F')
    LSIGMAX: str = Field('T')
